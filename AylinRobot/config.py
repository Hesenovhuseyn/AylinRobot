...
class Config:
   ...
   MONGODB_URI = os.environ.get("MONGODB_URI", "mongodb+srv://GulFidanRoBot:GulFidanRoBot@gulfidanrobot.a3paj0t.mongodb.net/?retryWrites=true&w=majority")
   LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001962032043"))
