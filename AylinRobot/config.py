...
class Config:
   ...
   PLAYLIST_ID = int(os.environ.get("PLAYLIST_ID", "-1002103f"))
   BAN_GROUP = int(os.environ.get("BAN_GROUP", "-1002f"))
   ...
   CHANNEL = os.environ.get("CHANNEL", "sevgi_wlog")
   SUPPORT = os.environ.get("SUPPORT", "Kohne_Baki")
